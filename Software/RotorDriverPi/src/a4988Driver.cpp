...
a4988Driver::a4988Driver(uint8_t enablePin, uint8_t dirPin, uint8_t stepPin, uint8_t ms1Pin, uint8_t ms2Pin, uint8_t ms3Pin)
{
    _enable = enablePin;
    _dir = dirPin;
    _step = stepPin;
...
void a4988Driver::setMode(uint8_t mode) {
...
void a4988Driver::setDirection(uint8_t direction) {
...
void a4988Driver::setSpeed(uint8_t speed) {
...
void a4988Driver::stepDegrees(float degrees) {
...
void a4988Driver::_updateDriver() {
