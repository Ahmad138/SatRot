...
#include <math.h>
#include "includes/helper.h" //Some helper functions and variables
...
{
  public:
    /** Constructor initialisation when creating a stepperDriver instance
     *
     ...
     */
    stepperDriver(uint8_t enablePin, uint8_t dirPin, uint8_t stepPin, uint8_t ms1Pin, uint8_t ms2Pin, uint8_t ms3Pin);
