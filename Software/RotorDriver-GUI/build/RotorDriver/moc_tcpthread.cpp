...
#include "../../RotorDriver/includes/tcpthread.h"
...
void TCPThread::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            using _t = void (TCPThread::*)(QTcpSocket::SocketError );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&TCPThread::error)) {
                *result = 0;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject TCPThread::staticMetaObject = {
    { &QThread::staticMetaObject, qt_meta_stringdata_TCPThread.data,
      qt_meta_data_TCPThread,  qt_static_metacall, nullptr, nullptr}
};
